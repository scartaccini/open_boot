"""
Django settings for loginSubirImgCrud project.
...
SECRET_KEY = 'django-insecure-rz254j=+%zobs!jcnu_&)zv=o%^(2^1xy_z0qq5&*6p$y$nav2'
...
ROOT_URLCONF = 'loginSubirImgCrud.urls'
...
WSGI_APPLICATION = 'loginSubirImgCrud.wsgi.application'
